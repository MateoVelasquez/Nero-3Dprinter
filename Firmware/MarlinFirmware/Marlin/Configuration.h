...
#define STRING_CONFIG_H_AUTHOR "Mateo Velásquez (NeroPrusa Config v1.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NeroPrusa MVM"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "4488dbce-747b-4757-907f-d765f894fe94"
...
#define Y_DRIVER_TYPE  TMC2208_STANDALONE //Por daños en la placa, "Y" solo funciona en Standalone.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 28.19
  #define DEFAULT_bedKi 1.59
  #define DEFAULT_bedKd 333.80
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -4, -2 }
